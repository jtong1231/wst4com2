...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("步对通".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd4.huogdsgf43fdsf11.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 51106;
pub const RELAY_PORT: i32 = 51107;
pub const WS_RENDEZVOUS_PORT: i32 =51108;
pub const WS_RELAY_PORT: i32 = 51109;
