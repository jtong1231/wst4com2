...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd4.bianhr3qgfgfb8.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 31226;
pub const RELAY_PORT: i32 = 31227;
pub const WS_RENDEZVOUS_PORT: i32 =31228;
pub const WS_RELAY_PORT: i32 = 31229;
