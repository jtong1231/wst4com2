...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd4.diufgrw432f2.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 56296;
pub const RELAY_PORT: i32 = 56297;
pub const WS_RENDEZVOUS_PORT: i32 =56298;
pub const WS_RELAY_PORT: i32 = 56299;
