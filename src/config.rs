...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd4.yingewrgdsg4few15.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 56096;
pub const RELAY_PORT: i32 = 56097;
pub const WS_RENDEZVOUS_PORT: i32 =56098;
pub const WS_RELAY_PORT: i32 = 56099;
