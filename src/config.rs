...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd4.guabdwa34tf13.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 30326;
pub const RELAY_PORT: i32 = 30327;
pub const WS_RENDEZVOUS_PORT: i32 =30328;
pub const WS_RELAY_PORT: i32 = 30329;
