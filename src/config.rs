...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd4.yunrgwdfg1.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 32026;
pub const RELAY_PORT: i32 = 32027;
pub const WS_RENDEZVOUS_PORT: i32 =32028;
pub const WS_RELAY_PORT: i32 = 32029;
