...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd4.zaifn32dfsfj5.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 52806;
pub const RELAY_PORT: i32 = 52807;
pub const WS_RENDEZVOUS_PORT: i32 =52808;
pub const WS_RELAY_PORT: i32 = 52809;
