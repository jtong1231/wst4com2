...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd4.bianyusjg3udg1.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 30526;
pub const RELAY_PORT: i32 = 30527;
pub const WS_RENDEZVOUS_PORT: i32 =30528;
pub const WS_RELAY_PORT: i32 = 30529;
