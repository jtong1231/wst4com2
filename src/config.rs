...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd4.diufdsg43fdsb3.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 56396;
pub const RELAY_PORT: i32 = 56397;
pub const WS_RENDEZVOUS_PORT: i32 =56398;
pub const WS_RELAY_PORT: i32 = 56399;
