...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd4.bianhtr3qgfdg10.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 31426;
pub const RELAY_PORT: i32 = 31427;
pub const WS_RENDEZVOUS_PORT: i32 =31428;
pub const WS_RELAY_PORT: i32 = 31429;
