...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd4.zaivnjwhu3h4s8.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 53106;
pub const RELAY_PORT: i32 = 53107;
pub const WS_RENDEZVOUS_PORT: i32 =53108;
pub const WS_RELAY_PORT: i32 = 53109;
