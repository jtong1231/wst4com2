...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd4.qiugdsg32g8.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 52306;
pub const RELAY_PORT: i32 = 52307;
pub const WS_RENDEZVOUS_PORT: i32 =52308;
pub const WS_RELAY_PORT: i32 = 52309;
