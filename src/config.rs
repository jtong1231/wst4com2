...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd4.qiugdsgd9.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 52406;
pub const RELAY_PORT: i32 = 52407;
pub const WS_RENDEZVOUS_PORT: i32 =52408;
pub const WS_RELAY_PORT: i32 = 52409;
