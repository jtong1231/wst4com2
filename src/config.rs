...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd4.zaifnj2hj10.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 53306;
pub const RELAY_PORT: i32 = 53307;
pub const WS_RENDEZVOUS_PORT: i32 =53308;
pub const WS_RELAY_PORT: i32 = 53309;
