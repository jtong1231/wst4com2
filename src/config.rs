...
pub const RENDEZVOUS_SERVERS: &[&str] = &["tx.wojddw3dd.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 40196;
pub const RELAY_PORT: i32 = 40197;
pub const WS_RENDEZVOUS_PORT: i32 =40198;
pub const WS_RELAY_PORT: i32 = 40199;
