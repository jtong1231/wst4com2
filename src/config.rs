...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd4.guah43wagdfgh4d14.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 30426;
pub const RELAY_PORT: i32 = 30427;
pub const WS_RENDEZVOUS_PORT: i32 =30428;
pub const WS_RELAY_PORT: i32 = 30429;
