...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("经元通".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd4.huogdsgdsmk8.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 50806;
pub const RELAY_PORT: i32 = 50807;
pub const WS_RENDEZVOUS_PORT: i32 =50808;
pub const WS_RELAY_PORT: i32 = 50809;
