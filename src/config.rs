...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd4.guab3qafdeg4gfd10.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 30026;
pub const RELAY_PORT: i32 = 30027;
pub const WS_RENDEZVOUS_PORT: i32 =30028;
pub const WS_RELAY_PORT: i32 = 30029;
