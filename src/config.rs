...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd4.guaghwraw3afgdsg11.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 30126;
pub const RELAY_PORT: i32 = 30127;
pub const WS_RENDEZVOUS_PORT: i32 =30128;
pub const WS_RELAY_PORT: i32 = 30129;
