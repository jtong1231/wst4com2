...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd4.qiugeg4w7.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 52206;
pub const RELAY_PORT: i32 = 52207;
pub const WS_RENDEZVOUS_PORT: i32 =52208;
pub const WS_RELAY_PORT: i32 = 52209;
