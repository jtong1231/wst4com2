...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("要理宝".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd4.huogdsgsa6.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 50606;
pub const RELAY_PORT: i32 = 50607;
pub const WS_RENDEZVOUS_PORT: i32 =50608;
pub const WS_RELAY_PORT: i32 = 50609;
