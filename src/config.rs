...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd4.zaifn32hdsa4.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 52706;
pub const RELAY_PORT: i32 = 52707;
pub const WS_RENDEZVOUS_PORT: i32 =52708;
pub const WS_RELAY_PORT: i32 = 52709;
