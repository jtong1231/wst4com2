...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd4.guabnr3q4gfd12.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 30226;
pub const RELAY_PORT: i32 = 30227;
pub const WS_RENDEZVOUS_PORT: i32 =30228;
pub const WS_RELAY_PORT: i32 = 30229;
