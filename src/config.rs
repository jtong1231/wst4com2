...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd4.huogdsg3fes12.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 51206;
pub const RELAY_PORT: i32 = 51207;
pub const WS_RENDEZVOUS_PORT: i32 =51208;
pub const WS_RELAY_PORT: i32 = 51209;
