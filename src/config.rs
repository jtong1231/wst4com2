...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd4.bianb54wtre9.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 31326;
pub const RELAY_PORT: i32 = 31327;
pub const WS_RENDEZVOUS_PORT: i32 =31328;
pub const WS_RELAY_PORT: i32 = 31329;
