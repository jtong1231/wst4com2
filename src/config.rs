...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd4.huodgf4wf10.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 51006;
pub const RELAY_PORT: i32 = 51007;
pub const WS_RENDEZVOUS_PORT: i32 =51008;
pub const WS_RELAY_PORT: i32 = 51009;
