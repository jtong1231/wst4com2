...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd4.bianhfwet4gf11.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 31526;
pub const RELAY_PORT: i32 = 31527;
pub const WS_RENDEZVOUS_PORT: i32 =31528;
pub const WS_RELAY_PORT: i32 = 31529;
