...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd4.huogdsvcv7.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 50706;
pub const RELAY_PORT: i32 = 50707;
pub const WS_RENDEZVOUS_PORT: i32 =50708;
pub const WS_RELAY_PORT: i32 = 50709;
