...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd4.bianghq3gfdggfgr15.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 31926;
pub const RELAY_PORT: i32 = 31927;
pub const WS_RENDEZVOUS_PORT: i32 =31928;
pub const WS_RELAY_PORT: i32 = 31929;
