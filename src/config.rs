...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cd4.bianbtqfgh43fg5.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 30926;
pub const RELAY_PORT: i32 = 30927;
pub const WS_RENDEZVOUS_PORT: i32 =30928;
pub const WS_RELAY_PORT: i32 = 30929;
